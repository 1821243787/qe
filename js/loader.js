(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_67c974795c31f6c22807e761")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '67c970a4aec720bbd905b0f4';
_mrmcp['creative_id'] = '67c974795c31f6c22807e761';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = 'dd';
_mrmcp['build_number'] = parseInt('338');
_mrmcp['publish_time'] = 'Thu Mar 06 2025 20:33:39 GMT+0800 (China Standard Time)';
_mrmcp['last_modified'] = '';
_mrmcp['jsapi_config_url'] = '';
_mrmcp['stat_host'] = 'https://67c974795c31f6c22807e761.stat.mugeda.com/stats/c.gif';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.3.38';
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        var resPath = jsPath;
            ...
            loadRes(0, resPath + "mugeda_smart_renderer_richtext" + version + ".js", [0], 1);
        
        loadRes(0, resPath + "mugeda_utils" + version + ".js", [0]);
        loadRes(1, jsPath + that.crid + ".js?publishTime=1741264419062", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1741264419062" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
